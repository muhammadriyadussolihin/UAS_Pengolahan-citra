...
def process_image(image_path, k):
    ...
    st.image(segmented_image,
             caption=f'Segmented Image (K={k})', use_column_width=True)
    ...
    for i, center in enumerate(centers):
        with cols[i % 4]:
            ...
            st.image(color_patch_img,
                     caption=f'Color: {center}', use_column_width=False)
...
k = st.number_input("Enter the number of clusters (k):",
